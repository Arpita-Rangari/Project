...
public class CartController {
    ...
    public ResponseEntity<MessageResponse> deleteCartItem(@PathVariable("cartItemId") Integer itemId, Authentication auth) {
    	//step1:Get the current principle 
    	System.out.println("...............................");
		User user = userrepo.findByUsername(auth.getName()).orElseThrow(() -> new RuntimeException("Please Login in "));
		System.out.println(user.getUsername());
...
//		System.out.println("Quantity" +quantity); //removed
		
		
			//product id 
			int pid=cartdto.getBookId();
				System.out.println("course id "+pid);
			
			String msg = cartservice.updatecart(id,pid, user);
